...
const Cart = () => {
  ...
  // Local loading state for checkout process
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      setIsCheckingOut(false); // Stop Loading on error
    }
  };
  ...
  // SHOW LOADER DURING CHECKOUT HANDOFF
  if (isCheckingOut) {
    return <Loader />;
  }
            ...
            <div key={product._id} className="flex justify-between items-center bg-white p-6 rounded-xl shadow-sm border border-gray-100 transition hover:shadow-md relative">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <span className="text-xs font-bold text-gray-500 uppercase tracking-wider bg-gray-100 px-2 py-1 rounded w-fit">
              ...
              <div className="flex flex-col items-end gap-4">
                <div className="flex items-center font-bold text-xl bg-gray-100 rounded-full">
                  <button 
                    ...
                    className="w-8 h-8 flex items-center justify-center hover:bg-gray-200 rounded-full transition text-gray-600"
                  >
                    -
                  </button>
        ...
        <div className="flex-1 border border-gray-200 rounded-xl p-8 bg-white shadow-lg h-fit sticky top-24 min-w-[300px]">
          ...
          <div className="space-y-3 text-gray-600 text-base">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium text-gray-900">$ 5.90</span>
            </div>
          ...
          <div className="flex justify-between items-center mt-6 mb-8 pt-4 border-t border-gray-200">
            ...
            <span className="text-2xl font-extrabold text-gray-900">
              $ {Math.max(0, cart.total).toFixed(2)}
            </span>
          </div>
          
          <button 
            onClick={handleCheckout} 
            className="w-full bg-black text-white font-bold py-4 rounded-xl hover:bg-gray-800 transition transform active:scale-95 shadow-lg tracking-wider"
          >
            CHECKOUT NOW
          </button>
        </div>
